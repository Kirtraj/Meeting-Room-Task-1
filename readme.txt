...
The required Python packages are listed in `requirements.txt`. The packages must be installed in the system to run the source code file (MeetingRoom task-1.py).
